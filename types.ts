...
export enum AuditAction {
  ...
  PASSWORD_MIGRATION = 'PASSWORD_MIGRATION', // Added for security audit
  ...
  SECURITY_VIOLATION = 'SECURITY_VIOLATION', // NEW: For tracking auth failures
  WEBHOOK_FAILURE = 'WEBHOOK_FAILURE', // NEW: For persistent queue failures
