    ...
    <div className="p-8 h-screen flex flex-col animate-in fade-in duration-500 relative">
      <header className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Gerencie prontuários e histórico.</p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
                <thead className="bg-slate-50 border-b border-slate-200 sticky top-0 z-10">
                    <tr>
                        ...
                        <th className="px-6 py-4 font-semibold text-slate-600 text-sm">Condição</th>
                        <th className="px-6 py-4 font-semibold text-slate-600 text-sm">Última Visita</th>
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                              ...
                              <div className="p-3 bg-slate-50 rounded-lg col-span-2">
                                  ...
                                  <p className="font-medium text-slate-800">{selectedPatient.nextStep || 'None'}</p>
                              </div>
                          </div>
                      </div>
